...
class LivestreamSummarizerGradio:
    ...
    def run_summarizer(self, youtube_url, api_key, video_duration, segment_duration, 
        ...
        if video_duration < 60:
            error_msg = f"❌ Error: Video clip duration must be at least 60 seconds to avoid Gemini API rate limits.\nCurrent value: {video_duration} seconds\nPlease increase the video clip duration to 60 or more."
